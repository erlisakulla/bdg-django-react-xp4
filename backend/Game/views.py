...
from Game.models import game, DemandPattern, PlayerGame, Weeks
...
class WeeksEdit(generics.ListCreateAPIView):
    permission_classes = [IsAuthenticated]
    serializer_class = weekSerializer

    def get_queryset(self):
        return Weeks.objects.filter(
            player_id=self.request.user, game_id=self.request.GET["game_id"]
        )
