...
class EditGame extends Component {
    ...
    componentDidMount() {
        ...
        if (this.props.match.params.id == null) {
            ...
            this.setState({post : "game/edit/" + this.props.match.params.id + "/"});
    ...
    render() {
        ...
        return (
            <div className="container w-50" style={{paddingTop:30}}>
              <h3 className="text-center">{this.state.post == "game/" ? "Create Game":"Edit Game"}</h3>
                ...
                <form className="col s12">
                  ...
                  <div className="row">
                    <div className="input-field col s12">
                      <input
                        ...
                        onChange={this.handleOnChange}
                        className="validate"
                        disabled= {this.state.post == "game/edit/" + this.props.match.params.id + "/"}
                  ...
                  <div className="d-flex align-items-center justify-content-center">
                    <button
                      ...
                      style={{marginTop:30}}
                    >
                      {this.state.post == "game/" ? "Create Game":"Edit Game"}{" "}
                    </button>
                  </div>
                </form>
              </div>
