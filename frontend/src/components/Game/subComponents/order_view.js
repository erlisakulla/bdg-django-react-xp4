                        ...
                        <div className="card">
                            <ul className="list-group list-group-flush">
                                <li className="list-group-item">
                                    ...
                                    <span className="badge bg-dark float-end" style={{color:'white'}}>4</span>
                                </li>
                                <li className="list-group-item">
                                    Back Order
                                    <span className="badge bg-danger float-end" style={{color:'white'}}>4</span>
                                </li>
                                <li className="list-group-item">
                                    Total Requirements
                                    <span className="badge bg-primary float-end" style={{color:'white'}}>4</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div className="col-sm-5   m-3">
                        <div className="card">
                            <ul className="list-group list-group-flush">
                                ...
                                <li className="list-group-item">
                                    Incoming Shipment
                                    <span className="badge bg-success float-end" style={{color:'white'}}>4</span>
                                </li>
                                <li className="list-group-item">
                                    Total Availiable
                                    <span className="badge bg-primary float-end" style={{color:'white'}}>4</span>
                ...
                <div className="row justify-content-center m-3">
                    <div className="row mb-3">
                        ...
                        <div className="col-sm-2">
                            <Form.Control type="number" name="order" id="inpnum1"/>
                            {/* <input
                                type="number"
                                name="tosend"
